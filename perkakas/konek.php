...
$query = "SELECT * FROM perkakas WHERE id = $id";
...
function tambah1($data3)
{
    ...
    $data2 =  "INSERT INTO perkakas (nama, code, harga, stok) VALUES ('$nama', '$code', '$harga', '$stok')";
...
{
    global $koneksi;
    mysqli_query($koneksi, "DELETE FROM perkakas WHERE id='$_GET[id]'");
    return mysqli_affected_rows($koneksi);
}
